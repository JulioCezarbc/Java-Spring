package com.julioCord.todosimple.exceptions;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements
    ...
    public ResponseEntity<Object> handleDataIntegrityViolationException(
            ...
            WebRequest request){
        String erroMessage = dataIntegrityViolationException.getMostSpecificCause().getMessage();
        log.error("Failed to save entity with integrity problems: " + erroMessage, dataIntegrityViolationException);
        return buildErrorResponse(
